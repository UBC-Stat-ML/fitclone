export CORWDIR="/home/ssalehi/projects/corrupt2_/corrupt-nextflow/work"
#ID1=$(ls -td -1 /home/ssalehi/projects/corrupt2_/corrupt-nextflow/work/** | head -n1); 
...
C1=$(stat -c %Y $ID2/arguments.tsv)
C2=$(stat -c %Y $ID2/samples/fnr.csv)
C3=$(expr $C2 - $C1)
